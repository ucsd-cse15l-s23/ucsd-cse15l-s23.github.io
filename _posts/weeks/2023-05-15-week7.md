...
After the 15 minutes are up, clone this repository which has a subset of the
...
reminder, you're changing the `index1` to `index2` in the expected value of the
test). Re-run the tests to make sure it works. Keep extremely accurate track of
...
you.  Then, you will measure your improvement as you learn to 
complete the command line tasks most efficiently.
